...
#ifndef PINGONEVERIFY_SWIFT_H
#define PINGONEVERIFY_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="PingOneVerify",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
/// Base class for IDCameraController framework, implementing core logic. Subclassable (subclass it to implement your own interface)
SWIFT_CLASS("_TtC13PingOneVerify22IDCameraControllerBase")
@interface IDCameraControllerBase : UIViewController
- (void)viewDidLoad;
...
- (IBAction)retakeButtonPressed:(UIButton * _Nonnull)sender;
...
@interface IDCameraControllerBase (SWIFT_EXTENSION(PingOneVerify))
- (void)handleCapturedImage:(IDImage * _Nonnull)image;
@end



/// Main class for IDCameraController framework, implementing a view controller taking a user’s photo.
SWIFT_CLASS("_TtC13PingOneVerify22IDCameraViewController")
@interface IDCameraViewController : IDCameraControllerBase
@property (nonatomic, readonly) BOOL prefersStatusBarHidden;
/// Use this view to present a custom view within the IDCameraController (e.g. branding, custom interface etc)
@property (nonatomic, readonly, strong) IBOutlet UIView * _Nullable customViewContainer;
- (void)viewDidLoad;
- (void)viewDidDisappear:(BOOL)animated;
...
/// Class that caches different types of image data.
/// Can be initialized with CMSampleBuffer, UIImage, CVSampleBuffer or png/jpeg image data, and can produce other types on demand (except CMSampleBuffer).
/// Important: Avoid retaining too many of these objects. If you do, call <code>releaseSampleBuffer()</code> or nil the <code>sampleBuffer</code> property to prevent stalling the AVCaptureOutput, as it has a limited pool (usually 12) of CMSampleBuffers.
SWIFT_CLASS("_TtC13PingOneVerify7IDImage")
@interface IDImage : NSObject
/// Creates an empty IDImage. It has to be initialized with one of the image formats.
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


@interface IDImage (SWIFT_EXTENSION(PingOneVerify))
...
SWIFT_CLASS("_TtC13PingOneVerify19PhotoCaptureService")
...
@interface PhotoCaptureService (SWIFT_EXTENSION(PingOneVerify)) <AVCaptureVideoDataOutputSampleBufferDelegate>
...
@property (nonatomic) BOOL optional;
@property (nonatomic, strong) id <RequirementsProtocol> _Nullable requirements;
- (nonnull instancetype)initWithCaptureTime:(NSTimeInterval)captureTime shouldCaptureAfterTimeout:(BOOL)shouldCaptureAfterTimeout optional:(BOOL)optional requirements:(id <RequirementsProtocol> _Nullable)requirements OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
